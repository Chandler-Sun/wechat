...
var tpl = ['<xml>',
  ...
  '<% } else if (msgType === "hardware") { %>',
    ...
    '<FuncFlag>0</FuncFlag>',
  '<% } else if (msgType === "transfer_customer_service") { %>',
  '<% } else if (msgType === "device_status") { %>',
    '<DeviceType><![CDATA[<%-content.deviceType%>]]></DeviceType>',
    '<DeviceID><![CDATA[<%-content.deviceId%>]]></DeviceID>',
    '<DeviceStatus><![CDATA[<%-content.deviceStatus%>]]></DeviceStatus>',
  '<% } else { %>',
